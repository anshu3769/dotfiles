...
" wraps the content when window size is decreased
set wrap
...
" }}}
"
"map f7 key with curly braces
map! <F7> <C-R>='{}'<CR>


"map f9 key with function/class braces
map! <F9> <C-R>='()'<CR>


"map f3 key with square braces
map! <F3> <C-R>='[]'<CR>


"map f1 key with assignment operator
map! <F1> <C-R>=' = '<CR>


"map f2 key with return keyword
map! <F2> <C-R>='return'<CR>
